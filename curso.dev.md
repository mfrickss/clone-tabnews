...
Muito sobre Docker e PostgreSQL, aprendi bastante coisa sobre ambos. principalmente o compose.yaml q eu nunca tinha entendido direito. Aproveitei para reforçar o conhecimento sobre proxys, já que para instalar o postgres tive que usar o wsl para poder usar os comandos: sudo apt update, sudo apt install postgres-client. depois usei o psql(cliente de linha de comando para o Postgres) dentro do wsl para entrar no env do database. Configurei o yaml manualmente e descobri coisas interessantes.
...
Aulas sobre dotenv, o dotenv já vem nativo no next(checar se node tb), o resto é o básico.



###### ***DIA 19:***

Mensurar os tradeoffs, n fazer implementações fantasmas. 
